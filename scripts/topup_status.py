...
目标：词汇短语作业（vocabulary）+ 雅思专项四子栏目（阅读节选小题 / 听力精听 /
...
NAMES = {"vocabulary": "词汇短语作业",
         "ielts_reading": "阅读节选小题", "ielts_listening": "听力精听（文稿+题目）",
...
def main():
    ...
    if missing:
        ...
        print("TOPUP_OK|vocabulary,ielts_reading,ielts_listening,ielts_essay,"
